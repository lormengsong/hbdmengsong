...
$('document').ready(function(){
	...
	$('#turn_on').click(function(){
		$(".demo").html('<img src="banner.png" class="bannar">');
	...
	$('#balloons_flying').click(function(){
		$(".song source").attr('src', 'mengsonghbd.mp3');
		var audio = $('.song')[0];
	...
	$('#wish_message').click(function(){
		 vw = $(window).width()/2;
		 $(".song source").attr('src', 'hbddear.mp3');
		 var audio = $('.song')[0];
	...
	simulateButtonClick('#cake_fadein', 80000);
	simulateButtonClick('#light_candle', 100000);
	simulateButtonClick('#wish_message', 120000);
	simulateButtonClick('#story', 150000);
